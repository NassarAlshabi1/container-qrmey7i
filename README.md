...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-qrmey7i.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-qrmey7i.containers.anotherwebservice.com/
...
```
git clone git@github.com:NassarAlshabi1/container-qrmey7i.git
cd container-qrmey7i
```
...
```
docker attach container-qrmey7i
```
